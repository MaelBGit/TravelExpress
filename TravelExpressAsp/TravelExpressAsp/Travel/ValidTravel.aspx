...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="id_journey" DataSourceID="SqlDataSource1" ForeColor="#333333" GridLines="None" Height="50px" Width="410px" OnPageIndexChanging="DetailsView1_PageIndexChanging">
...
&nbsp;max:
        <asp:ListBox ID="ListBox1" runat="server" DataSourceID="SqlDataSource2" DataTextField="AvailablePlaces" DataValueField="price" Height="20px" Width="44px" Enabled="False" EnableTheming="False" EnableViewState="False" OnDataBound="ListBox1_DataBound" OnSelectedIndexChanged="ListBox1_SelectedIndexChanged"></asp:ListBox>
